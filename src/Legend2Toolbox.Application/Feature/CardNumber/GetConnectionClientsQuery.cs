...
public class
    GetConnectionClientsQueryHandler : IRequestHandler<GetConnectionClientsQuery, Result<IEnumerable<ConnectionInfo>>>
{
    private readonly IConnectionManager _connectionManager;
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;

    public GetConnectionClientsQueryHandler(IConnectionManager connectionManager, IApplicationDbContext context,
    ...
    public async Task<Result<IEnumerable<ConnectionInfo>>> Handle(GetConnectionClientsQuery request,

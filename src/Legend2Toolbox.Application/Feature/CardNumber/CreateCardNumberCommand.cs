...
public class CreateCardNumberCommandHandler : IRequestHandler<CreateCardNumberCommand, Result<Guid>>
{
    ...
    public CreateCardNumberCommandHandler(ICurrentUserService currentUserService, IApplicationDbContext context,
        ILogger<CreateCardNumberCommandHandler> logger, IPublisher publisher)
    {
